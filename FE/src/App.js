...
import Sqli from './components/Admin/SQLInjectionLogs.js';
    ...
    <Suspense fallback={<Loader />}>
      ...
      <div className="main-container">
        ...
        <Route path="/admin/dashboard" element={<Dashboard />} />
          ...
          <Route path="/admin/dashboard" element={isAuthenticated && user?.role === "0" ? <Dashboard /> : <Login />} />
          <Route path="/admin/products" element={isAuthenticated && user?.role === "0" ? <ProductList /> : <Login />} />
          <Route path="/admin/product/" element={isAuthenticated && user?.role === "0" ? <NewProduct /> : <Login />} />
          <Route path="/admin/product/:id" element={isAuthenticated && user?.role === "0" ? <UpdateProduct /> : <Login />} />
          <Route path="/admin/orders" element={isAuthenticated && user?.role === "0" ? <OrderList /> : <Login />} />
          <Route path="/admin/logs" element={isAuthenticated && user?.role === "0" ? <Sqli /> : <Login />} />
          <Route path="/admin/order/:id" element={isAuthenticated && user?.role === "0" ? <UpdateOrder /> : <Login />} />
          <Route path="/admin/users" element={isAuthenticated && user?.role === "0" ? <Users /> : <Login />} />
          <Route path="/admin/user/:id" element={isAuthenticated && user?.role === "0" ? <UpdateUser /> : <Login />} />
          <Route path="/admin/reviews" element={isAuthenticated && user?.role === "0" ? <Reviews /> : <Login />} />

          <Route path="/admin/banners" element={isAuthenticated && user?.role === "0" ? <Banners /> : <Login />} />
          <Route path="/admin/banner/" element={isAuthenticated && user?.role === "0" ? <NewBanner /> : <Login />} />
          <Route path="/admin/banner/:id" element={isAuthenticated && user?.role === "0" ? <UpdateBanner /> : <Login />} />
        </Routes>
      </div>
      <Footer />
    </Suspense>
