...
import { clearError, getProductDetails, newReview, getAllReviews, deleteReview } from "../../redux/actions/productActions";
...
import { NEW_REVIEWS_RESET, DELETE_REVIEWS_RESET } from "../../redux/constants/productConstants"
...
const ProductDetails = () => {
      ...
      }, [error, reviewError, success, isDeleted, alert, dispatch, id]);
                                    ...
                                    <div className="maylike-products-wrapper">
                                          ...
                                          <div className="marquee">
                                                <div className="maylike-products-container track">
                                                      {similarProducts && similarProducts.map((product) => <ProductCart key={product.id} product={product} />)}
                                                </div>
                                          </div>
                                    </div>
                              </div>
